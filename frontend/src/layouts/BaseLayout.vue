...
const mockCategories = [
  ...
  { key: 'laptops', label: 'Ноутбуки ПК і планшети', href: '/categories/laptops' },
  ...
  { key: 'clothes', label: 'Одяг, взуття та аксесуари', href: '/categories/clothes' },
  ...
  { key: 'collectibles', label: 'Колекції, старі предмети', href: '/categories/collectibles' },
...
<template>
  <div class=" min-h-screen flex flex-col bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-200 overflow-x-hidden">
    <header class="sticky top-0 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 shadow-sm">
      <div class="container mx-auto px-4 py-3">
        <div class="flex items-center justify-between">
            ...
            <template v-for="item in navItems" :key="item.path">
              ...
              >
                <button
                  ...
                  :class="{ 'text-amber-600 dark:text-amber-400': megaMenuOpen }"
          ...
          <!-- Search bar -->
          <div class="hidden lg:flex items-center bg-white dark:bg-gray-700 rounded-full px-4 py-2 border border-gray-300 dark:border-gray-600">
          ...
          <div class="flex items-center space-x-3">
            ...
            <div ref="notificationsRef" class="relative">
              ...
              <NotificationsDropdown
                ...
                :notifications="[
                  { id: 1, text: 'Your bid was outbid!', time: '2 min ago', read: false },
                  { id: 2, text: 'Auction ending soon', time: '15 min ago', read: true },
                  { id: 3, text: 'New message from seller', time: '1 hour ago', read: false }
                ]"
              />
            </div>
            ...
            <div ref="cartRef" class="relative">
              ...
              <CartDropdown
                v-if="cartOpen"
                :items="[
                  { id: 1, name: 'Vintage Watch', price: 240, image: 'https://placehold.co/40x40' },
                  { id: 2, name: 'Classic Car Model', price: 89, image: 'https://placehold.co/40x40' }
                ]"
              />
            </div>
            ...
            <div ref="userMenuRef" class="relative">
              ...
              <UserMenu
                v-if="userMenuOpen"
                :user="{ name: 'John Doe', email: 'john@example.com', verified: true }"
              />
            </div>
          </div>
        </div>
